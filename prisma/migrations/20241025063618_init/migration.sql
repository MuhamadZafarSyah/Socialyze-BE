...
-- AddForeignKey
ALTER TABLE `Follow` ADD CONSTRAINT `Follow_followingProfileId_fkey` FOREIGN KEY (`followingProfileId`) REFERENCES `Profile`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
